...
describe('.getAddress()', function () {
  it('should work', function () {
    assert.strictEqual(fixtureWallet.getAddress().toString('hex'), '2bd2ece73d454097a8aaeba7bf426456ee95d252')
  })
})

describe('.getAddressString()', function () {
  it('should work', function () {
    assert.strictEqual(fixtureWallet.getAddressString(), '0x2bd2ece73d454097a8aaeba7bf426456ee95d252')
  })
})

describe('.getChecksumAddressString()', function () {
  it('should work', function () {
    assert.strictEqual(fixtureWallet.getChecksumAddressString(), '0x2bD2eCe73D454097a8AAEbA7Bf426456EE95d252')
  })
})
...
describe('public key only wallet', function () {
  ...
  it('.fromPublicKey() should not accept compressed keys in strict mode', function () {
    assert.throws(function () {
      Wallet.fromPublicKey(Buffer.from('03ad7ae1d8b435941e25c60f9aff78474e1e2553a13e55381fd17d9dd900702e26', 'hex'))
    }, /^Error: Invalid public key$/)
  })
  it('.fromPublicKey() should accept compressed keys in non-strict mode', function () {
    var tmp = Buffer.from('03ad7ae1d8b435941e25c60f9aff78474e1e2553a13e55381fd17d9dd900702e26', 'hex')
    assert.strictEqual(Wallet.fromPublicKey(tmp, true).getPublicKey().toString('hex'), fixturePublicKey)
  })
  it('.getAddress() should work', function () {
    assert.strictEqual(Wallet.fromPublicKey(pubKey).getAddress().toString('hex'), '2bd2ece73d454097a8aaeba7bf426456ee95d252')
  })
...
describe('.fromExtendedPrivateKey()', function () {
  it('should work', function () {
    ...
    assert.strictEqual(Wallet.fromExtendedPrivateKey(xprv).getAddressString(), '0x273f37b9c8752e6d7b18cec460a416647909487c')
  })
})

describe('.fromExtendedPublicKey()', function () {
  it('should work', function () {
    var xpub = 'xpub661MyMwAqRbcGout4B6s29b6gGQsowyoiF6UgXBEr7eFCWYfXuZDvRxP9xJm5wNCsk1Gx2PkTg2QRQddnGa1qZwZmhBUwbkr8wsB9cAc3bc'
    assert.strictEqual(Wallet.fromExtendedPublicKey(xpub).getAddressString(), '0x273f37b9c8752e6d7b18cec460a416647909487c')
  })
})
...
describe('.getV3Filename()', function () {
  it('should work', function () {
    assert.strictEqual(fixtureWallet.getV3Filename(1457917509265), 'UTC--2016-03-14T01-05-09.265Z--2bd2ece73d454097a8aaeba7bf426456ee95d252')
  })
})
...
describe('.toV3()', function () {
  ...
  it('should work with PBKDF2', function () {
    var w = '{"version":3,"id":"7e59dc02-8d42-409d-b29a-a8a0f862cc81","address":"2bd2ece73d454097a8aaeba7bf426456ee95d252","crypto":{"ciphertext":"01ee7f1a3c8d187ea244c92eea9e332ab0bb2b4c902d89bdd71f80dc384da1be","cipherparams":{"iv":"cecacd85e9cb89788b5aab2f93361233"},"cipher":"aes-128-ctr","kdf":"pbkdf2","kdfparams":{"dklen":32,"salt":"dc9e4a98886738bd8aae134a1f89aaa5a502c3fbd10e336136d4d5fe47448ad6","c":262144,"prf":"hmac-sha256"},"mac":"0c02cd0badfebd5e783e0cf41448f84086a96365fc3456716c33641a86ebc7cc"}}'
  ...
  it('should work with Scrypt', function () {
    var w = '{"version":3,"id":"7e59dc02-8d42-409d-b29a-a8a0f862cc81","address":"2bd2ece73d454097a8aaeba7bf426456ee95d252","crypto":{"ciphertext":"c52682025b1e5d5c06b816791921dbf439afe7a053abb9fac19f38a57499652c","cipherparams":{"iv":"cecacd85e9cb89788b5aab2f93361233"},"cipher":"aes-128-ctr","kdf":"scrypt","kdfparams":{"dklen":32,"salt":"dc9e4a98886738bd8aae134a1f89aaa5a502c3fbd10e336136d4d5fe47448ad6","n":262144,"r":8,"p":1},"mac":"27b98c8676dc6619d077453b38db645a4c7c17a3e686ee5adaf53c11ac1b890e"}}'
    this.timeout(180000) // 3minutes
    // FIXME: just test for ciphertext and mac?
...
describe('.fromV3()', function () {
  it('should work with PBKDF2', function () {
    ...
    assert.strictEqual(wallet.getAddressString(), '0x83fe73ca1e37e759533cb508bf242e71c39c532d')
  })
  it('should work with Scrypt', function () {
    ...
    this.timeout(180000) // 3minutes
    assert.strictEqual(wallet.getAddressString(), '0xd7e63584a6899f4be2c3dbe636fb028a3c3c0be6')
  })
  it('should work with \'unencrypted\' wallets', function () {
    ...
    this.timeout(180000) // 3minutes
    assert.strictEqual(wallet.getAddressString(), '0x80d2a4ae9ca3c8699748748ff6b02dbcf3e1ab99')
  })
...
describe('.fromEthSale()', function () {
  ...
  var json = '{"encseed": "81ffdfaf2736310ce87df268b53169783e8420b98f3405fb9364b96ac0feebfb62f4cf31e0d25f1ded61f083514dd98c3ce1a14a24d7618fd513b6d97044725c7d2e08a7d9c2061f2c8a05af01f06755c252f04cab20fee2a4778130440a9344", "ethaddr": "86c4da4e428ed9c8b24606363fe2d29e9caf4ba5", "email": "hello@ethereum.org", "btcaddr": "1DHW32MFwHxU2nk2SLAQq55eqFotT9jWcq"}'
  it('should work', function () {
    var wallet = Wallet.fromEthSale(json, 'testtest')
    assert.strictEqual(wallet.getAddressString(), '0x86c4da4e428ed9c8b24606363fe2d29e9caf4ba5')
  })
})

describe('.fromEtherWallet()', function () {
  it('should work with unencrypted input', function () {
    var etherWalletUnencrypted = '{"address":"0x130c901a444f75e964a21ea2da2cd3be38bae4b9","encrypted":true,"locked":false,"hash":"b7a6621e8b125a17234d3e5c35522696a84134d98d07eab2479d020a8613c4bd","private":"a2c6222146ca2269086351fda9f8d2dfc8a50331e8a05f0f400c13653a521862","public":"2fa97b5bd58f898684f0a00dfa20a0ea74826b03fe5e609d76dd2416dc8090e35d72adf8c89f232312e64a771298994d0c229208dbc18d2a846ed30247f49a6e"}'
    var wallet = Thirdparty.fromEtherWallet(etherWalletUnencrypted)
    assert.strictEqual(wallet.getAddressString(), '0x130c901a444f75e964a21ea2da2cd3be38bae4b9')
  })
  /*
